  ...
  <div class="lg:pt-10">
    ...
    >
      <router-link
        ...
        :to="{ name: 'Home', query: { max: 'works', folder: 'works', file: $route.query.file, active: 'works' } }"
        >My works</router-link
      >
      <router-link
        class="text-center w-1/2 rounded-lg bg-button-gray shadow-sm text-lg py-3 px-[30px] hover:shadow-sm-hovered hover:translate-x-[2px] hover:translate-y-[2px]"
        :to="{ name: 'Home', query: { max: 'contact', folder: $route.query.folder, file: 'contact', active: 'contact' } }"
